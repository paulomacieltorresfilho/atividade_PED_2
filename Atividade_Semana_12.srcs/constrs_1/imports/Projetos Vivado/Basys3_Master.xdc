...
set_property PACKAGE_PIN U2 [get_ports {sel_display[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_display[0]}]
set_property PACKAGE_PIN U4 [get_ports {sel_display[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_display[1]}]
set_property PACKAGE_PIN V4 [get_ports {sel_display[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_display[2]}]
set_property PACKAGE_PIN W4 [get_ports {sel_display[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sel_display[3]}]
